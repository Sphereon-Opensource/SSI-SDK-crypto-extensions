...
describe('functions: validateX5cCertificateChain', () => { // FIXME SDK-46
  ...
  it('should validate with client id scheme x509_san_dns and san_uri', async () => {
    ...
    expect(() =>
      assertCertificateMatchesClientIdScheme(pemOrDerToX509Certificate(sphereonTest), 'funke.demo.sphereon.com', 'x509_san_uri')
    ).toThrow()
  })
})
